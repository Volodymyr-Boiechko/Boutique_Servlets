                ...
                <div class="orderItem__block">
                    ...
                    <div class="orderItem__block__infoOrder">
                        ...
                        <div class="orderItem__block__infoOrder__img">
                            <img src="${pageContext.request.contextPath}/img/profile/box.png">
                        </div>
                ...
                <div class="orderItem__block">
                    ...
                    <div class="orderItem__block__products">
                        ...
                        <div class="orderItem__block__products__title">
                            ${products.size()}
                            <c:if test="${products.size() == 1}"> товар</c:if>
                            <c:if test="${products.size() > 1 && products.size() <= 4}"> товари</c:if>
                            <c:if test="${products.size() > 4}"> товарів</c:if>
                        </div>
                                    ...
                                    <div class="orderItem__block__products__block__text__char">
                                        ...
                                        <c:if test="${not empty product.model}">
                                            ...
                                            <div class="orderItem__block__products__block__text__char__label">
                                                ...
                                                <div class="orderItem__block__products__block__text__char__label_title">Модель</div>
                                        ...
                                        <c:if test="${not empty product.color}">
                                            ...
                                            <div class="orderItem__block__products__block__text__char__label">
                                                ...
                                                <div class="orderItem__block__products__block__text__char__label_title">Колір:</div>
                                        ...
                                        <c:if test="${not empty product.size}">
                                            ...
                                            <div class="orderItem__block__products__block__text__char__label">
                                                ...
                                                <div class="orderItem__block__products__block__text__char__label_title">Розмір:</div>
                ...
                <div class="orderItem__block">
                    ...
                    <div class="orderItem__block__address">
                        ...
                        <div class="orderItem__block__address__block">
                            ...
                            <div class="orderItem__block__address__block_element">${order.timeOrder.toLocalDate().plusDays(21)}</div>
